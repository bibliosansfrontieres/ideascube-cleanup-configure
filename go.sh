...
curl -sfL https://gitlab.com/bibliosansfrontieres/olip/olip-deploy/raw/master/go.sh | bash -s -- --name ideascube --url ideascube.io --descriptor http://drop.bsf-intranet.org/olip/conf-i386 --storage /media/hdd
